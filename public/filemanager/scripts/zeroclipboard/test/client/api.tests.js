...
(function (module, test) {
    ...
    test("`setText` works", function (assert) {
        ...
        assert.deepEqual(_clipData, {
            "text/plain": "goodbye",
            "text/html": "<b>Win</b>"
        }, "`_clipData` contains expected updated text AND the other data");
    });
    ...
    test("`setHtml` works", function (assert) {
        ...
        assert.deepEqual(_clipData, {
            "text/html": "<i>goodbye</i>",
            "text/plain": "blah"
        }, "`_clipData` contains expected updated HTML AND the other data");
    });
    ...
    test("`setRichText` works", function (assert) {
        ...
        assert.deepEqual(_clipData, {
            ...
            "text/plain": "blah"
        }, "`_clipData` contains expected updated RTF AND the other data");
    });
    ...
    test("`setData` works", function (assert) {
        ...
        assert.deepEqual(_clipData, {
            "text/plain": "zc4evar",
            "text/html": "<i>ZeroClipboard</i>"
        }, "`_clipData` contains expected text and custom format");
