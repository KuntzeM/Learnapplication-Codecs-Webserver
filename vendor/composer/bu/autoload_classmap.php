...
return array(
    'CodecsTableSeeder' => $baseDir . '/database/backup/CodecsTableSeeder.php',
    'ConfigurationsSeeder' => $baseDir . '/database/backup/ConfigurationsSeeder.php',
    'CreateCodecsTable' => $baseDir . '/database/backup/create_codecs_table.php',
    'CreateConfigurationsTable' => $baseDir . '/database/backup/create_configurations_table.php',
    'CreateFailedJobsTable' => $baseDir . '/database/backup/create_failed_jobs_table.php',
    'CreateJobsTable' => $baseDir . '/database/backup/create_jobs_table.php',
    'CreateMediaCodecConfigsTable' => $baseDir . '/database/backup/create_media_codec_configs_table.php',
    'CreateMediaTable' => $baseDir . '/database/backup/create_media_table.php',
    'CreatePasswordResetsTable' => $baseDir . '/database/backup/create_password_resets_table.php',
    'CreateUsersTable' => $baseDir . '/database/backup/create_users_table.php',
    'DatabaseSeeder' => $baseDir . '/database/backup/DatabaseSeeder.php',
    ...
    'UsersTableSeeder' => $baseDir . '/database/backup/UsersTableSeeder.php',
);
