...
class ComposerStaticInit98e9a9be9198e4656bfe287b96b6a32d
{
    ...
    public static $classMap = array (
        'CodecsTableSeeder' => __DIR__ . '/../..' . '/database/backup/CodecsTableSeeder.php',
        'ConfigurationsSeeder' => __DIR__ . '/../..' . '/database/backup/ConfigurationsSeeder.php',
        'CreateCodecsTable' => __DIR__ . '/../..' . '/database/backup/create_codecs_table.php',
        'CreateConfigurationsTable' => __DIR__ . '/../..' . '/database/backup/create_configurations_table.php',
        'CreateFailedJobsTable' => __DIR__ . '/../..' . '/database/backup/create_failed_jobs_table.php',
        'CreateJobsTable' => __DIR__ . '/../..' . '/database/backup/create_jobs_table.php',
        'CreateMediaCodecConfigsTable' => __DIR__ . '/../..' . '/database/backup/create_media_codec_configs_table.php',
        'CreateMediaTable' => __DIR__ . '/../..' . '/database/backup/create_media_table.php',
        'CreatePasswordResetsTable' => __DIR__ . '/../..' . '/database/backup/create_password_resets_table.php',
        'CreateUsersTable' => __DIR__ . '/../..' . '/database/backup/create_users_table.php',
        'DatabaseSeeder' => __DIR__ . '/../..' . '/database/backup/DatabaseSeeder.php',
        ...
        'UsersTableSeeder' => __DIR__ . '/../..' . '/database/backup/UsersTableSeeder.php',
    );
